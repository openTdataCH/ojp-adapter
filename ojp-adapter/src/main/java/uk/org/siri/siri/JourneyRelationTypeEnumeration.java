...
public enum JourneyRelationTypeEnumeration {
    ...
    /**
     * The journey is a continuation of the specified RelatedJourney at the stop point given in CallInfo.
     * Passengers don't need to change vehicles. The new journey is not communicated as an interchange.
     * 
     */
    ...
    /**
     * The journey is continued by the specified RelatedJourney at the stop point given in CallInfo.
     * Passengers don't need to change vehicles. The new journey is not communicated as an interchange.
     * 
     */
