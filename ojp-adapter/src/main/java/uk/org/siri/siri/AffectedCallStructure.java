    ...
    extends AffectedStopPointStructure
{
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the arrivalPlatformName property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the departurePlatformName property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
