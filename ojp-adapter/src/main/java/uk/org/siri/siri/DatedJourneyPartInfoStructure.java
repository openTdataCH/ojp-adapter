 ...
 * 
 * <p>Java-Klasse für DatedJourneyPartInfoStructure complex type.
 * 
...
@XmlType(name = "DatedJourneyPartInfoStructure", propOrder = {
    "journeyPartRef",
    "trainNumberRef",
    "operatorRef",
    "compoundTrainRef",
...
public class DatedJourneyPartInfoStructure {
    ...
    public DatedJourneyPartInfoStructure withJourneyPartRef(String value) {
        setJourneyPartRef(value);
        return this;
    }

    public DatedJourneyPartInfoStructure withTrainNumberRef(TrainNumberRefStructure value) {
        setTrainNumberRef(value);
        return this;
    }

    public DatedJourneyPartInfoStructure withOperatorRef(OperatorRefStructure value) {
        setOperatorRef(value);
        return this;
    }

    public DatedJourneyPartInfoStructure withCompoundTrainRef(CompoundTrainRefStructure value) {
        setCompoundTrainRef(value);
        return this;
    }

    public DatedJourneyPartInfoStructure withFromStopPointRef(StopPointRefStructure value) {
        setFromStopPointRef(value);
        return this;
    }

    public DatedJourneyPartInfoStructure withToStopPointRef(StopPointRefStructure value) {
        setToStopPointRef(value);
        return this;
    }

    public DatedJourneyPartInfoStructure withStartTime(ZonedDateTime value) {
        setStartTime(value);
        return this;
    }

    public DatedJourneyPartInfoStructure withEndTime(ZonedDateTime value) {
        setEndTime(value);
        return this;
    }
