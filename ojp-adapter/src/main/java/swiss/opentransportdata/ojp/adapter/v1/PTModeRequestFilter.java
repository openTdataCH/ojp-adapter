 ...
 * OJP v1.x filter.
 */
public interface PTModeRequestFilter extends PIRequestFilter {

    /**
     * Included or excluded public-transport modes.
     * @see swiss.opentransportdata.ojp.adapter.transmodel.v6.part1.commonconcepts.reusablecomponents.transportmode.Mode
     */
