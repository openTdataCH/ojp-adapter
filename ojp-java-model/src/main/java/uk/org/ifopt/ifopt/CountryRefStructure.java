 ...
 *
 * <p>Java-Klasse für CountryRefStructure complex type.
 *
...
public class CountryRefStructure {
     ...
     *
     * @param value allowed object is {@link IanaCountryTldEnumeration }
     */
    public void setValue(IanaCountryTldEnumeration value) {
        this.value = value;
    }

    public CountryRefStructure withValue(IanaCountryTldEnumeration value) {
        setValue(value);
        return this;
    }
