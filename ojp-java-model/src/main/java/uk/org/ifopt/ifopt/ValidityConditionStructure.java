...
public class ValidityConditionStructure {
     ...
     * is why there is not a <CODE>set</CODE> method for the timebands property.
     *
     * <p>
     ...
     *
     * <p>
     * Objects of the following type(s) are allowed in the list {@link ValidityConditionStructure.Timebands }
     */
    ...
    public static class Timebands {
         ...
         *
         * @return possible object is {@link TimebandStructure }
         */
         ...
         *
         * @param value allowed object is {@link TimebandStructure }
         */
