 ...
 *
 * <p>Java-Klasse für FormationStatusStructure complex type.
 *
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Status" type="{http://www.siri.org.uk/siri}FormationChangeEnumeration"/&gt;
...
@XmlType(name = "FormationStatusStructure", propOrder = {
    "status",
    "description",
    "accessibilityAssessment",
    "extensions"
})
public class FormationStatusStructure {
     ...
     *
     * @return possible object is {@link FormationChangeEnumeration }
     */
     ...
     *
     * @param value allowed object is {@link FormationChangeEnumeration }
     */
    ...
    public FormationStatusStructure withStatus(FormationChangeEnumeration value) {
        setStatus(value);
        return this;
    }

    public FormationStatusStructure withDescription(NaturalLanguageStringStructure... values) {
        if (values != null) {
    ...
    public FormationStatusStructure withDescription(Collection<NaturalLanguageStringStructure> values) {
        if (values != null) {
    ...
    public FormationStatusStructure withAccessibilityAssessment(AccessibilityAssessmentStructure value) {
        setAccessibilityAssessment(value);
        return this;
    }

    public FormationStatusStructure withExtensions(ExtensionsStructure value) {
        setExtensions(value);
        return this;
    }
