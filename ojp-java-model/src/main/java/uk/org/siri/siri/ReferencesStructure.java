...
public class ReferencesStructure {
     ...
     * is why there is not a <CODE>set</CODE> method for the relatedToRef property.
     *
     * <p>
     ...
     *
     * <p>
     * Objects of the following type(s) are allowed in the list {@link RelatedSituationStructure }
     */
