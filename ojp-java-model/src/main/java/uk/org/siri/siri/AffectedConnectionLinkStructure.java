...
public class AffectedConnectionLinkStructure {
     ...
     * is why there is not a <CODE>set</CODE> method for the connectionLinkRef property.
     *
     * <p>
     ...
     * <p>
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the returned list will be present inside the Jakarta XML Binding object. This
     * is why there is not a <CODE>set</CODE> method for the connectingStopPointName property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     *
     * @return possible object is {@link ConnectionDirectionEnumeration }
     */
     ...
     *
     * @param value allowed object is {@link ConnectionDirectionEnumeration }
     */
     ...
     * <p>
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the returned list will be present inside the Jakarta XML Binding object. This
     * is why there is not a <CODE>set</CODE> method for the affectedPathLink property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
