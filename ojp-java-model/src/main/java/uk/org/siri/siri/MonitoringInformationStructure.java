...
/**
 * Allowed values for the monitoring conditions (frequency of measurement, etc): an automatic monitoring of the status of a lift with pushed alert in case of incident is very different from a daily
 * manual/visual check.
 *
...
public class MonitoringInformationStructure {
     ...
     *
     * @return possible object is {@link MonitoringTypeEnumeration }
     */
     ...
     *
     * @param value allowed object is {@link MonitoringTypeEnumeration }
     */
