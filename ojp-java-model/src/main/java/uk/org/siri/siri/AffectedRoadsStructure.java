...
public class AffectedRoadsStructure {
     ...
     * is why there is not a <CODE>set</CODE> method for the affectedRoad property.
     *
     * <p>
     ...
     *
     * <p>
     * Objects of the following type(s) are allowed in the list {@link AffectedRoadStructure }
     */
