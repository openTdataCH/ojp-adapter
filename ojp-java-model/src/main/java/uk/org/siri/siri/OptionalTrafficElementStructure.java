...
/**
 * An event which is not planned by the traffic OPERATOR, which is affecting, or has the potential to affect traffic flow. This SIRI-SX element embeds the Datex2 TrafficElement, making all elements
 * optional because they may alternatvielky be specified by common SIRI-SRX SITUATION elements.
 *
...
public abstract class OptionalTrafficElementStructure {
     ...
     *
     * @return possible object is {@link Impact }
     */
     ...
     *
     * @param value allowed object is {@link Impact }
     */
     ...
     *
     * @return possible object is {@link Cause }
     */
     ...
     *
     * @param value allowed object is {@link Cause }
     */
     ...
     * is why there is not a <CODE>set</CODE> method for the generalPublicComment property.
     *
     * <p>
     ...
     * <p>
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the returned list will be present inside the Jakarta XML Binding object. This
     * is why there is not a <CODE>set</CODE> method for the nonGeneralPublicComment property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     *
     * @param value allowed object is {@link GroupOfLocations }
     */
     ...
     *
     * @return possible object is {@link Management }
     */
     ...
     *
     * @param value allowed object is {@link Management }
     */
