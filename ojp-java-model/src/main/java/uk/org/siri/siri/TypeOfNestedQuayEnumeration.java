...
public enum TypeOfNestedQuayEnumeration {
    ...
    /**
     * A QUAY of type 'platformEdge' may be divided into multiple sectors, e.g. "A", "B", "C" etc., to help passengers find a specific part of a vehicle. The first class carriage of a TRAIN might, for
     * example, be assigned to sector "A" of a QUAY.
     */
