...
public class PredefinedLocationSet {
     ...
     * is why there is not a <CODE>set</CODE> method for the predefinedLocation property.
     *
     * <p>
     ...
     *
     * <p>
     * Objects of the following type(s) are allowed in the list {@link PredefinedLocation }
     */
