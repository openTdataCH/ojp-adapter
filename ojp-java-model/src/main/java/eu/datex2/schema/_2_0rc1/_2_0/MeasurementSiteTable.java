...
public class MeasurementSiteTable {
     ...
     * is why there is not a <CODE>set</CODE> method for the measurementSiteRecord property.
     *
     * <p>
     ...
     *
     * <p>
     * Objects of the following type(s) are allowed in the list {@link MeasurementSiteRecord }
     */
