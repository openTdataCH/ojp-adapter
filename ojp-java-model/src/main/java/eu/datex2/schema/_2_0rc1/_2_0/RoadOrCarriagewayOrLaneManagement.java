...
public class RoadOrCarriagewayOrLaneManagement
     ...
     *
     * @return possible object is {@link RoadOrCarriagewayOrLaneManagementTypeEnum }
     */
     ...
     *
     * @param value allowed object is {@link RoadOrCarriagewayOrLaneManagementTypeEnum }
     */
     ...
     * is why there is not a <CODE>set</CODE> method for the specifiedCarriageway property.
     *
     * <p>
     ...
     *
     * <p>
     * Objects of the following type(s) are allowed in the list {@link CarriagewayEnum }
     */
     ...
     * <p>
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the returned list will be present inside the Jakarta XML Binding object. This
     * is why there is not a <CODE>set</CODE> method for the specifiedLane property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     *
     * <p>
     * Objects of the following type(s) are allowed in the list {@link LaneEnum }
     */
