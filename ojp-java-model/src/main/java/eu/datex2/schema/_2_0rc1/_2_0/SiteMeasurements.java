...
public class SiteMeasurements {
     ...
     * is why there is not a <CODE>set</CODE> method for the measuredValue property.
     *
     * <p>
     ...
     *
     * <p>
     * Objects of the following type(s) are allowed in the list {@link SiteMeasurements.MeasuredValue }
     */
