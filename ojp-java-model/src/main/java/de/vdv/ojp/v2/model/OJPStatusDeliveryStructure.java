...
/**
 * <p>Java-Klasse für OJPStatusDeliveryStructure complex type.
 *
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 *
 * <pre>
 * &lt;complexType name="OJPStatusDeliveryStructure"&gt;
 *   &lt;complexContent&gt;
 *     &lt;extension base="{http://www.siri.org.uk/siri}AbstractServiceDeliveryStructure"&gt;
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://www.vdv.de/ojp}OJPStatusRequest" minOccurs="0"/&gt;
...
@XmlType(name = "OJPStatusDeliveryStructure", propOrder = {
    "rest"
})
public class OJPStatusDeliveryStructure
    extends AbstractServiceDeliveryStructure {

    @XmlElementRefs({
        @XmlElementRef(name = "OJPStatusRequest", namespace = "http://www.vdv.de/ojp", type = JAXBElement.class, required = false),
     ...
     * {@link JAXBElement }{@code <}{@link OJPStatusRequestStructure }{@code >} {@link JAXBElement }{@code <}{@link String }{@code >} {@link JAXBElement }{@code <}{@link BigInteger }{@code >}
     * {@link JAXBElement }{@code <}{@link ZonedDateTime }{@code >} {@link JAXBElement }{@code <}{@link ZonedDateTime }{@code >} {@link JAXBElement }{@code <}{@link ZonedDateTime }{@code >}
    ...
    public OJPStatusDeliveryStructure withRest(JAXBElement<?>... values) {
        if (values != null) {
    ...
    public OJPStatusDeliveryStructure withRest(Collection<JAXBElement<?>> values) {
        if (values != null) {
    ...
    @Override
    public OJPStatusDeliveryStructure withRequestMessageRef(MessageRefStructure value) {
        setRequestMessageRef(value);
        return this;
    }

    @Override
    public OJPStatusDeliveryStructure withSubscriberRef(ParticipantRefStructure value) {
        setSubscriberRef(value);
        return this;
    }

    @Override
    public OJPStatusDeliveryStructure withSubscriptionFilterRef(SubscriptionFilterRefStructure value) {
        setSubscriptionFilterRef(value);
        return this;
    }

    @Override
    public OJPStatusDeliveryStructure withSubscriptionRef(SubscriptionRefStructure value) {
        setSubscriptionRef(value);
        return this;
    }

    @Override
    public OJPStatusDeliveryStructure withDelegatorAddress(String value) {
        setDelegatorAddress(value);
        return this;
    }

    @Override
    public OJPStatusDeliveryStructure withDelegatorRef(ParticipantRefStructure value) {
        setDelegatorRef(value);
        return this;
    }

    @Override
    public OJPStatusDeliveryStructure withStatus(Boolean value) {
        setStatus(value);
        return this;
    }

    @Override
    public OJPStatusDeliveryStructure withErrorCondition(ServiceDeliveryErrorConditionStructure value) {
        setErrorCondition(value);
        return this;
    }

    @Override
    public OJPStatusDeliveryStructure withValidUntil(ZonedDateTime value) {
        setValidUntil(value);
        return this;
    }

    @Override
    public OJPStatusDeliveryStructure withShortestPossibleCycle(Duration value) {
        setShortestPossibleCycle(value);
        return this;
    }

    @Override
    public OJPStatusDeliveryStructure withDefaultLanguage(String value) {
        setDefaultLanguage(value);
        return this;
    }

    @Override
    public OJPStatusDeliveryStructure withResponseTimestamp(ZonedDateTime value) {
