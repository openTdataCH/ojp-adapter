...
/**
 * [TMv6] A type of PLACE providing the topographical context when searching for or presenting travel information, for example as the origin or destination of a trip. It may be of any size (e.g.,
 * County,City, Town, Village) and of different specificity (e.g., Greater London, London, West End, Westminster, St James's).
 *
...
public class TopographicPlaceStructure {
     ...
     * is why there is not a <CODE>set</CODE> method for the privateCode property.
     *
     * <p>
     ...
     *
     * @return possible object is {@link AreaStructure }
     */
     ...
     *
     * @param value allowed object is {@link AreaStructure }
     */
