...
/**
 * <p>Java-Klasse für OJPMultiPointTripDeliveryStructure complex type.
 *
...
public class OJPMultiPointTripDeliveryStructure
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "OJPMultiPointTripRequest", namespace = "http://www.vdv.de/ojp", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "MultiPointType", namespace = "http://www.vdv.de/ojp", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "MultiPointTripResponseContext", namespace = "http://www.vdv.de/ojp", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "MultiPointTripResult", namespace = "http://www.vdv.de/ojp", type = JAXBElement.class, required = false),
     ...
     *
     * <p>
     * Objects of the following type(s) are allowed in the list {@link JAXBElement }{@code <}{@link MultiPointTripResultStructure }{@code >}
     * {@link JAXBElement }{@code <}{@link MultiPointTypeEnumeration }{@code >} {@link JAXBElement }{@code <}{@link OJPErrorStructure }{@code >}
     * {@link JAXBElement }{@code <}{@link OJPMultiPointTripRequestStructure }{@code >} {@link JAXBElement }{@code <}{@link ResponseContextStructure }{@code >}
    ...
    public OJPMultiPointTripDeliveryStructure withRest(JAXBElement<?>... values) {
        if (values != null) {
    ...
    public OJPMultiPointTripDeliveryStructure withRest(Collection<JAXBElement<?>> values) {
        if (values != null) {
    ...
    @Override
    public OJPMultiPointTripDeliveryStructure withRequestMessageRef(MessageRefStructure value) {
    ...
    @Override
    public OJPMultiPointTripDeliveryStructure withSubscriptionRef(SubscriptionRefStructure value) {
