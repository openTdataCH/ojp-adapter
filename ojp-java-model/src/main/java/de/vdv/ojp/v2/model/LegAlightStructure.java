 ...
 *
 * <p>Java-Klasse für LegAlightStructure complex type.
 *
 ...
 *         &lt;element name="FeederInterchangeId" type="{http://www.w3.org/2001/XMLSchema}normalizedString" minOccurs="0"/&gt;
...
@XmlType(name = "LegAlightStructure", propOrder = {
    "stopPointRef",
    "stopPointName",
    "nameSuffix",
    "plannedQuay",
...
public class LegAlightStructure {
     ...
     *
     * @return possible object is {@link ServiceArrivalStructure }
     */
     ...
     *
     * @param value allowed object is {@link ServiceArrivalStructure }
     */
     ...
     *
     * @return possible object is {@link ServiceDepartureStructure }
     */
     ...
     *
     * @param value allowed object is {@link ServiceDepartureStructure }
     */
    ...
    /**
     * Ruft den Wert der feederInterchangeId-Eigenschaft ab.
     *
     * @return possible object is {@link String }
     */
    public String getFeederInterchangeId() {
        return feederInterchangeId;
    }

    /**
     * Legt den Wert der feederInterchangeId-Eigenschaft fest.
     *
     * @param value allowed object is {@link String }
     */
    public void setFeederInterchangeId(String value) {
        this.feederInterchangeId = value;
    }
    ...
    /**
     * The Occupancy structure from SIRI can be used here. It is recommended to mainly have one ExpectedDepartureOccupancy for each FareClass and mainly focus on OccupancyLevel and
     * OccupancyPercentage. For more details have a look at the SIRI documentation.Gets the value of the expectedDepartureOccupancy property.
     *
     * <p>
    ...
    /**
     * The Capacity structure also will probably rarely be used and parsed. When used, then it mainly shows elements that are important for accessibility.Gets the value of the
     * expectedDepartureCapacities property.
     *
     * <p>
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the returned list will be present inside the Jakarta XML Binding object. This
    ...
    public LegAlightStructure withStopPointRef(StopPointRefStructure value) {
        setStopPointRef(value);
        return this;
    }

    public LegAlightStructure withStopPointName(InternationalTextStructure value) {
        setStopPointName(value);
        return this;
    }

    public LegAlightStructure withNameSuffix(InternationalTextStructure value) {
        setNameSuffix(value);
        return this;
    }

    public LegAlightStructure withPlannedQuay(InternationalTextStructure value) {
        setPlannedQuay(value);
        return this;
    }

    public LegAlightStructure withEstimatedQuay(InternationalTextStructure value) {
        setEstimatedQuay(value);
        return this;
    }

    public LegAlightStructure withServiceArrival(ServiceArrivalStructure value) {
        setServiceArrival(value);
        return this;
    }

    public LegAlightStructure withServiceDeparture(ServiceDepartureStructure value) {
        setServiceDeparture(value);
        return this;
    }

    public LegAlightStructure withFeederInterchangeId(String value) {
        setFeederInterchangeId(value);
        return this;
    }

    public LegAlightStructure withMeetsViaRequest(Boolean value) {
        setMeetsViaRequest(value);
        return this;
    }

    public LegAlightStructure withOrder(BigInteger value) {
        setOrder(value);
        return this;
    }

    public LegAlightStructure withRequestStop(Boolean value) {
        setRequestStop(value);
        return this;
    }

    public LegAlightStructure withUnplannedStop(Boolean value) {
        setUnplannedStop(value);
        return this;
    }

    public LegAlightStructure withNotServicedStop(Boolean value) {
        setNotServicedStop(value);
        return this;
    }

    public LegAlightStructure withNoBoardingAtStop(Boolean value) {
        setNoBoardingAtStop(value);
        return this;
    }

    public LegAlightStructure withNoAlightingAtStop(Boolean value) {
        setNoAlightingAtStop(value);
        return this;
    }

    public LegAlightStructure withExpectedDepartureOccupancy(VehicleOccupancyStructure... values) {
        if (values != null) {
    ...
    public LegAlightStructure withExpectedDepartureOccupancy(Collection<VehicleOccupancyStructure> values) {
        if (values != null) {
    ...
    public LegAlightStructure withExpectedDepartureCapacities(PassengerCapacityStructure... values) {
        if (values != null) {
    ...
    public LegAlightStructure withExpectedDepartureCapacities(Collection<PassengerCapacityStructure> values) {
        if (values != null) {
    ...
    public LegAlightStructure withAttribute(GeneralAttributeStructure... values) {
        if (values != null) {
    ...
    public LegAlightStructure withAttribute(Collection<GeneralAttributeStructure> values) {
        if (values != null) {
