...
/**
 * <p>Java-Klasse für OJPLocationInformationDeliveryStructure complex type.
 *
...
public class OJPLocationInformationDeliveryStructure
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "OJPLocationInformationRequest", namespace = "http://www.vdv.de/ojp", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "LocationInformationResponseContext", namespace = "http://www.vdv.de/ojp", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "ContinueAt", namespace = "http://www.vdv.de/ojp", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "PlaceResult", namespace = "http://www.vdv.de/ojp", type = JAXBElement.class, required = false),
     ...
     * {@link JAXBElement }{@code <}{@link OJPLocationInformationRequestStructure }{@code >} {@link JAXBElement }{@code <}{@link PlaceResultStructure }{@code >}
     * {@link JAXBElement }{@code <}{@link ResponseContextStructure }{@code >} {@link JAXBElement }{@code <}{@link BigInteger }{@code >} {@link JAXBElement }{@code <}{@link BigInteger }{@code >}
    ...
    public OJPLocationInformationDeliveryStructure withRest(JAXBElement<?>... values) {
        if (values != null) {
    ...
    public OJPLocationInformationDeliveryStructure withRest(Collection<JAXBElement<?>> values) {
        if (values != null) {
    ...
    @Override
    public OJPLocationInformationDeliveryStructure withRequestMessageRef(MessageRefStructure value) {
    ...
    @Override
    public OJPLocationInformationDeliveryStructure withSubscriptionRef(SubscriptionRefStructure value) {
