...
public class AvailabilityResultStructure {
     ...
     *
     * @return possible object is {@link BookingPTLegStructure }
     */
     ...
     *
     * @param value allowed object is {@link BookingPTLegStructure }
     */
     ...
     * <p>
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the returned list will be present inside the Jakarta XML Binding object. This
     * is why there is not a <CODE>set</CODE> method for the bookableTicket property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * <p>
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the returned list will be present inside the Jakarta XML Binding object. This
     * is why there is not a <CODE>set</CODE> method for the bookableServiceItem property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     *
     * <p>
     * Objects of the following type(s) are allowed in the list {@link BookableServiceItemStructure }
     */
