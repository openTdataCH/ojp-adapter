...
/**
 * Combinations of MODE and MODE OF OPERATION that should be covered as monomodal trips (or for the ACCESS LEGs). If no MODE OF OPERATION is added usually "own" is assumed. But the trip planner may
 * add other relevant results (e.g., sharing, if sensible trips are possible).
 *
...
public class ItModesStructure {
     ...
     * is why there is not a <CODE>set</CODE> method for the personalModeOfOperation property.
     *
     * <p>
     ...
     *
     * <p>
     * Objects of the following type(s) are allowed in the list {@link PersonalModesOfOperationEnumeration }
     */
     ...
     * <p>
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the returned list will be present inside the Jakarta XML Binding object. This
     * is why there is not a <CODE>set</CODE> method for the alternativeModeOfOperation property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     *
     * <p>
     * Objects of the following type(s) are allowed in the list {@link AlternativeModesOfOperationEnumeration }
     */
