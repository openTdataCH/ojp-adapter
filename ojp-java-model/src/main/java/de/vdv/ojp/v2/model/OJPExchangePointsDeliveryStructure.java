...
/**
 * <p>Java-Klasse für OJPExchangePointsDeliveryStructure complex type.
 *
...
public class OJPExchangePointsDeliveryStructure
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "OJPExchangePointsRequest", namespace = "http://www.vdv.de/ojp", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "ExchangePointsResponseContext", namespace = "http://www.vdv.de/ojp", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "ContinueAt", namespace = "http://www.vdv.de/ojp", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "ExchangePointsResult", namespace = "http://www.vdv.de/ojp", type = JAXBElement.class, required = false),
     ...
     *
     * <p>
     * Objects of the following type(s) are allowed in the list {@link JAXBElement }{@code <}{@link ExchangePointsResultStructure }{@code >}
     * {@link JAXBElement }{@code <}{@link OJPErrorStructure }{@code >} {@link JAXBElement }{@code <}{@link OJPExchangePointsRequestStructure }{@code >}
    ...
    public OJPExchangePointsDeliveryStructure withRest(JAXBElement<?>... values) {
        if (values != null) {
    ...
    public OJPExchangePointsDeliveryStructure withRest(Collection<JAXBElement<?>> values) {
        if (values != null) {
    ...
    @Override
    public OJPExchangePointsDeliveryStructure withRequestMessageRef(MessageRefStructure value) {
    ...
    @Override
    public OJPExchangePointsDeliveryStructure withSubscriptionRef(SubscriptionRefStructure value) {
