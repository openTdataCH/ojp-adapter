...
/**
 * <p>Java-Klasse für OJPTripDeliveryStructure complex type.
 *
...
public class OJPTripDeliveryStructure
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "OJPTripRequest", namespace = "http://www.vdv.de/ojp", type = JAXBElement.class, required = false),
     ...
     *
     * <p>
     * Objects of the following type(s) are allowed in the list {@link JAXBElement }{@code <}{@link OJPErrorStructure }{@code >} {@link JAXBElement }{@code <}{@link OJPTripRequestStructure }{@code >}
     * {@link JAXBElement }{@code <}{@link ResponseContextStructure }{@code >} {@link JAXBElement }{@code <}{@link TripResultStructure }{@code >}
    ...
    public OJPTripDeliveryStructure withRest(JAXBElement<?>... values) {
        if (values != null) {
    ...
    public OJPTripDeliveryStructure withRest(Collection<JAXBElement<?>> values) {
        if (values != null) {
    ...
    @Override
    public OJPTripDeliveryStructure withRequestMessageRef(MessageRefStructure value) {
    ...
    @Override
    public OJPTripDeliveryStructure withSubscriptionRef(SubscriptionRefStructure value) {
