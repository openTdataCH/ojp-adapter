...
/**
 * <p>Java-Klasse für OJPTripInfoDeliveryStructure complex type.
 *
...
public class OJPTripInfoDeliveryStructure
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "OJPTripInfoRequest", namespace = "http://www.vdv.de/ojp", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "TripInfoResponseContext", namespace = "http://www.vdv.de/ojp", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "TripInfoResult", namespace = "http://www.vdv.de/ojp", type = JAXBElement.class, required = false),
     ...
     * {@link JAXBElement }{@code <}{@link OJPTripInfoRequestStructure }{@code >} {@link JAXBElement }{@code <}{@link ResponseContextStructure }{@code >}
     * {@link JAXBElement }{@code <}{@link TripInfoResultStructure }{@code >} {@link JAXBElement }{@code <}{@link BigInteger }{@code >}
    ...
    public OJPTripInfoDeliveryStructure withRest(JAXBElement<?>... values) {
        if (values != null) {
    ...
    public OJPTripInfoDeliveryStructure withRest(Collection<JAXBElement<?>> values) {
        if (values != null) {
    ...
    @Override
    public OJPTripInfoDeliveryStructure withRequestMessageRef(MessageRefStructure value) {
    ...
    @Override
    public OJPTripInfoDeliveryStructure withSubscriptionRef(SubscriptionRefStructure value) {
