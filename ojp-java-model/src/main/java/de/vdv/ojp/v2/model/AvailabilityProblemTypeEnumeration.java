...
public enum AvailabilityProblemTypeEnumeration {
    ...
    /**
     * The vehicle is not available due to existing rules like operating hours or not competing against an existing public transport line. In the details of the problem there should be information
     * indicating which rules were violated: e.g., The desired MOBILITY SERVICE can't be provided because there exists a regular line for this TRIP.
     */
