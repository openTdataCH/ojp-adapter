...
/**
 * <p>Java-Klasse für OJPFareDeliveryStructure complex type.
 *
...
public class OJPFareDeliveryStructure
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "FareResponseContext", namespace = "http://www.vdv.de/ojp", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "FareResult", namespace = "http://www.vdv.de/ojp", type = JAXBElement.class, required = false),
     ...
     *
     * <p>
     * Objects of the following type(s) are allowed in the list {@link JAXBElement }{@code <}{@link FareResultStructure }{@code >} {@link JAXBElement }{@code <}{@link OJPErrorStructure }{@code >}
     * {@link JAXBElement }{@code <}{@link ResponseContextStructure }{@code >} {@link JAXBElement }{@code <}{@link BigInteger }{@code >}
    ...
    public OJPFareDeliveryStructure withRest(JAXBElement<?>... values) {
        if (values != null) {
    ...
    public OJPFareDeliveryStructure withRest(Collection<JAXBElement<?>> values) {
        if (values != null) {
    ...
    @Override
    public OJPFareDeliveryStructure withRequestMessageRef(MessageRefStructure value) {
    ...
    @Override
    public OJPFareDeliveryStructure withSubscriptionRef(SubscriptionRefStructure value) {
