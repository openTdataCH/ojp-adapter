...
/**
 * [TMv6] a link within a PLACE of or between two PLACEs (that is STOP PLACEs, ACCESS SPACEs or QUAYs, BOARDING POSITIONs, POINTs OF INTEREST etc. or PATH JUNCTIONs) that represents a step in a
 * possible route for pedestrians, cyclists, or other out-of-vehicle passengers within or between a PLACE. Here we use a reduced form of a PATH LINK containing the description of the type of
 * accessibility on this navigation section.
 *
...
public class PathLinkStructure {
     ...
     *
     * @return possible object is {@link TransitionEnumeration }
     */
     ...
     *
     * @param value allowed object is {@link TransitionEnumeration }
     */
     ...
     *
     * @return possible object is {@link AccessFeatureTypeEnumeration }
     */
     ...
     *
     * @param value allowed object is {@link AccessFeatureTypeEnumeration }
     */
     ...
     *
     * @return possible object is {@link AccessFeatureStatusEnumeration }
     */
     ...
     *
     * @param value allowed object is {@link AccessFeatureStatusEnumeration }
     */
     ...
     * is why there is not a <CODE>set</CODE> method for the accessibilityFeature property.
     *
     * <p>
     ...
     * <p>
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the returned list will be present inside the Jakarta XML Binding object. This
     * is why there is not a <CODE>set</CODE> method for the situationFullRef property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     *
     * @return possible object is {@link PathLinkEndStructure }
     */
     ...
     *
     * @param value allowed object is {@link PathLinkEndStructure }
     */
