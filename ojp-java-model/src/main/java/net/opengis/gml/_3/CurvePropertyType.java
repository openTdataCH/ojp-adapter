...
/**
 * A property that has a curve as its value domain may either be an appropriate geometry element encapsulated in an element of this type or an XLink reference to a remote geometry element (where
...
public class CurvePropertyType {
     ...
     *
     * @return possible object is {@link JAXBElement }{@code <}{@link AbstractCurveType }{@code >} {@link JAXBElement }{@code <}{@link LineStringType }{@code >}
     */
     ...
     *
     * @param value allowed object is {@link JAXBElement }{@code <}{@link AbstractCurveType }{@code >} {@link JAXBElement }{@code <}{@link LineStringType }{@code >}
     */
