...
/**
 * OJP Integration test annotation.
 */
@Target(ElementType.TYPE)
@Retention(RetentionPolicy.RUNTIME)
@ActiveProfiles({"ojp-adapter"})
@ExtendWith(SpringExtension.class)
@ContextConfiguration(classes = {OJPAdapterServiceConfiguration.class})
public @interface OJPTestProfile {
