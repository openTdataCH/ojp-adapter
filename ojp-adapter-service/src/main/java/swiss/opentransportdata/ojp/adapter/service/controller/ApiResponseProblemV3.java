...
import swiss.opentransportdata.ojp.adapter.service.controller.ApiResponseProblemV3.ApiResponsesProblem;
...
@Inherited
public @interface ApiResponseProblemV3 {
    ...
    @interface ApiResponsesProblem {
        ...
        ApiResponseProblemV3[] value() default {};
    }
}
