 ...
 * <p>
 * Goals: - domain/entity classes to DTOs, which are then sent to frontend as JSON objects in this VERY DIRECTION only. - DTO classes shouldn’t know about domain/entity classes and the other way
 * round. - No coupling between the two kinds of objects
 *
 * @author Peter Hirzel
...
public interface ModelConverter<T, R> {
     ...
     *
     * @param entity (for e.g. raw model)
     ...
     * @return entity (for e.g. raw model)
     */
     ...
     * @return entities (for e.g. raw model)
     */
