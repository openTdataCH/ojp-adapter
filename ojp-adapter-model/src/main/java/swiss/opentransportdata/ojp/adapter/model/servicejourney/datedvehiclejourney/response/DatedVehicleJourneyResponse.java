 ...
 * @author Peter Hirzel
 */
@Schema(description = "Contains a list of DatedVehicleJourney's matching the search-criteria.")
@Builder
@Value
public class DatedVehicleJourneyResponse implements JsonResponse, StopEventDelivery {

    @ArraySchema(minItems = 1, schema = @Schema(requiredMode = RequiredMode.REQUIRED,
        description = "Various DatedVehicleJourney options [1..*]."))
    @NonNull
    List<DatedVehicleJourney> datedVehicleJourneys;
}
