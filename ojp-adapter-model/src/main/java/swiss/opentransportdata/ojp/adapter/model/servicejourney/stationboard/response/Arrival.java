 ...
 * @author Peter Hirzel
 */
@Schema(description = "Arrival view of a kind of partial `DatedVehicleJourney` from a specific stop (typically very origin) towards the desired arrival stop-point.")
@Builder
@Value
public class Arrival implements ServiceJourneyPattern {
